      ...
      {q.mode === 'build' && (
        <>
          <div className="rounded-blob bg-white/70 p-3 shadow-soft">
            <p className="mb-1 font-heading text-xs text-slate-500">{t('level5.build.yourName')}</p>
            ...
            <div>
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {availableChunks.map(chunk => (
                  <button
                    key={chunk.id}
                    className="min-h-[44px] rounded-blob bg-lavender/50 px-4 py-2 font-mono text-sm text-slate-800 shadow-soft transition hover:scale-105"
